...
def abrir_log():
    ...
    delimitador = '#############################################################################################################\n' + \
                  '############################## Corrida correspondiente a la fecha ' + str(
        datetime.now().year) + '-' + str(datetime.now().month) + '-' + str(
        datetime.now().day) + ' #################################\n' + \
                  '#############################################################################################################\n'
...
def cerrar_log():
    pretty_log = open(archivo_de_logs, 'a')
    delimitador = '#############################################################################################################\n' + \
                  '################################ Fin correspondiente a la fecha ' + str(
        datetime.now().year) + '-' + str(datetime.now().month) + '-' + str(
        datetime.now().day) + ' ###################################\n' + \
                  '#############################################################################################################\n' + \
                  '-------------------------------------------------------------------------------------------------------------\n\n'
...
def send_alert(equipo):
    ...
    receivers = ['ialmandos@conatel.com.uy', 'dcetti@conatel.com.uy', 'eparedes@conatel.com.uy']
